...
/* harmony export */   Q: () => (/* binding */ getPostTeasers)
/* harmony export */ });
...
var token = 'patPnyhBFm76YUvgQ.4fa8871975fd6304e49d8f075bbd74b8ba33f761a5caf9adc7db84fe25b982f7';
airtable__WEBPACK_IMPORTED_MODULE_0___default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable__WEBPACK_IMPORTED_MODULE_0___default().base('appzXjfovKKA9DEfm');
...
(() => {
"use strict";
/* harmony import */ var _search_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(306);

var content;
document.addEventListener('DOMContentLoaded', function () {
  (0,_search_data__WEBPACK_IMPORTED_MODULE_0__/* .getPostTeasers */ .Q)().then(function (data) {
    content = data;
    createCards(content);
  });
});
